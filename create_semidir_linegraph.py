...
def random_walk(source_node, target_node):
    ...
    while stack != []:
        ...
        remaining = adj# and element not in visited]  # if we want the path to contain cycles, we should remove "and element not in visited"
...
if __name__ == "__main__":
    ...
    for source_node in range(48):
        cnt = 0  # to avoid some target not appear in training dataset
        for target_node in range(54, num_nodes):
