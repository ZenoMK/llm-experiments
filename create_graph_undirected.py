...
def generate_random_undirected_graph(num_nodes, edge_prob):
...
def get_reachable_nodes(TC, target_node):
    ...
    reachable_from = nx.node_connected_component(random_digraph, target_node)
...
def random_walk(source_node, target_node):
    ...
    while stack != []:
        ...
        adj = list(random_digraph[cur_node])
...
if __name__ == "__main__":
    ...
    random_digraph = generate_random_undirected_graph(num_nodes, edge_prob)
